...
public class ImageServiceImpl  implements  ImageService{
    ...
    public String upload(MultipartFile file, Long eventId ){
        ...
        if(isAnImageFile){
            try{
                ...
                throw new BadRequestException("Não é possivel salvar a imagem: " + file.getOriginalFilename()+ " Ocorreu um erro interno");
            }
        } else{
            throw new BadRequestException("Tipo de ficheiro invalido");
        }
    ...
    public Image download(Long userId) {
        var img = imageRepository.findByEventId(userId).orElseThrow(()->new EntityNotFoundException("Nao foi posssivel fazer o download da imagem"));
    ...
    public void delete(Long eventId) {
        ...
        var img = imageRepository.findByEventId(eventId).orElseThrow(()->
                new EntityNotFoundException("NAo e possivel eliminar a imagem."));
